...
def send_message(
    ...
    warnings.warn("'This function will be deprecated in a future release. "
                  "Use SlackNotifier().send_message() instead.'", DeprecationWarning)
    try:
...
def _send_job_status_message(
    ...
    """
    warnings.warn("'This function will be deprecated in a future release. "
                  "Use slack.SlackNotifier().monitor_job() instead.'", DeprecationWarning)
...
def monitor_job(
    ...
    warnings.warn("'This function will be deprecated in a future release. "
                  "Use SlackNotifier().monitor_job() instead.'", DeprecationWarning)
